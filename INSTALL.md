...
for your OS from
https://github.com/Netoxique/happypanda/releases
...
# Linux
1. Go where you want happypanda to be downloaded (E.g. `cd ~`), and write `git clone https://github.com/Netoxique/happypanda.git`
...
3. To install other dependencies
     - Download HappyPanda
        + Go to github.com/Netoxique/happypanda
